...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create Validator for validating fields
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String strPrice = productPrice.getText().toString();

                //Checks if the name and price fields are valid before adding
                if (validator.validProductName(name) && validator.validProductPrice(strPrice)) {
